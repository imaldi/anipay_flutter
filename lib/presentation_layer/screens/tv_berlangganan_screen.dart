...
const TVBerlanggananOptions = [
  'INDOVISION',
  'CENTRIN',
  'AORATV'
];
class TvBerlanggananScreen extends StatefulWidget {
  const TvBerlanggananScreen({Key? key}) : super(key: key);

  @override
  _TvBerlanggananScreenState createState() => _TvBerlanggananScreenState();
}

class _TvBerlanggananScreenState extends State<TvBerlanggananScreen> {
                  ...
                  child: Card(
                    child: Column(
                      children: [
                        ...
                        Divider(),
                        MyDropdownButton(TVBerlanggananOptions, giveStringValue,isEnabled: true,value: currentOption,onItemTapped: (val){
                          setState(() {
                            currentOption = val;
                          });
                        },)
